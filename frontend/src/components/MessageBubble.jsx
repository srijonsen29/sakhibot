...
import DocumentFormCard from './DocumentFormCard'
  ...
  return (
    <div className="mx-auto flex w-full max-w-3xl items-start gap-2.5
      ...
      <div className="flex-1 min-w-0 max-w-[92%] sm:max-w-[82%]">
        ...
        {/* new single-message multi-field document form (preferred flow) */}
        {msg.documentForm ? (
          <div className="mt-2">
            <DocumentFormCard
          ...
          /* legacy one-question-at-a-time document flow (kept for fallback) */
      ...
      {speaking
        ...
        : <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
              d="M15.536 8.464a5 5 0 010 7.072M12 6a7 7 0 010 12M8.464 8.464a5 5 0 000 7.072M6 12H4" />
          </svg>
      }
      Listen
    </button>
  ...
  return (
    <button onClick={share}
      ...
      <svg className="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.124.554 4.118 1.523 5.85L0 24l6.335-1.507A11.95 11.95 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 22c-1.907 0-3.688-.497-5.23-1.367l-.37-.22-3.861.918.936-3.752-.242-.385A9.953 9.953 0 012 12C2 6.486 6.486 2 12 2s10 4.486 10 10-4.486 10-10 10z"/>
      </svg>
      Share
    </button>
  )
