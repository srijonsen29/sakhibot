...
export default function DocumentFormCard({ form, language = 'en', onSubmitted }) {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      // axios throws on non-2xx; the 422 quality-gate rejection (with the
      // list of missing/invalid fields) lives on err.response, not in a
      // resolved response like raw fetch would give you.
