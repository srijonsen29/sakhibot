...
export default function DocumentCard({
  ...
  const LABELS = {
    ...
    dv_application: 'DV Act Application (Sec 12)',
    posh_complaint: 'POSH Complaint (ICC)',
  }
  ...
  return (
    <div className="mt-3 bg-white border border-emerald-200
      ...
      <div className="flex items-center gap-3">
        <div className="w-9 h-9 bg-emerald-100 rounded-lg flex
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-gray-400">
            {downloaded ? '✓ Downloaded' : 'Ready to print · PDF'}
          </p>
          {error && (
        ...
        <button
          ...
          className={`shrink-0 flex items-center gap-1.5 text-xs
                     font-medium rounded-lg px-3 py-2 transition-colors
                     disabled:opacity-50
                     ${downloaded
