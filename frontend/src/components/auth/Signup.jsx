...
export default function Signup({ error = '', loading = false, initialStep = 1, onStepChange, onSwitch, onSignup }) {
  ...
  const inputCls = hasErr =>
    `mt-1.5 w-full rounded-xl border px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 ${
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="relative mt-1.5">
                      ...
                      <input
                        ...
                        className={`w-full rounded-xl border px-4 py-3 pl-12 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 ${
                          errs.phone ? 'border-red-400 bg-red-50' : 'border-gray-300 bg-white'
                        }`}
                      />
                      {/* digit counter */}
                      <span
                        className={`absolute inset-y-0 right-3 flex items-center text-xs font-mono ${
                          contact.phone.length === 10 ? 'text-emerald-600' : 'text-gray-400'
                        }`}
                      >
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className={`mt-1.5 w-full rounded-xl border px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-400 bg-white ${
                        errs.relationship ? 'border-red-400 bg-red-50' : 'border-gray-300'
                      }`}
                    >
